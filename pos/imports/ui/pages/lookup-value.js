...
// Declare template
let indexTmpl = Template.Pos_lookupValue,
    optionsTmpl = Template.Pos_lookupValueOptions,
    formTmpl = Template.Pos_lookupValueForm;
...
formTmpl.onCreated(function () {
    this.autorun(()=> {
        ...
        if (currentData) {
            this.subscribe('pos.lookupValueById', currentData.lookupValueId);
        }
    });
});
...
AutoForm.addHooks(['Pos_lookupValueForm'], hooksObject);
