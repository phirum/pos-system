...
let indexTmpl = Template.Pos_customer,
    contactTmpl = Template.Pos_customerContact,
    formTmpl = Template.Pos_customerForm,
...
formTmpl.onCreated(function () {
    this.autorun(()=> {
        // Lookup value
        this.subscribe('pos.lookupValueByNames', ['Gender', 'Contact Type']);

        let currentData = Template.currentData();
        if (currentData) {
            this.subscribe('pos.customerById', currentData.customerId);
        }
    });
});
...
AutoForm.addHooks(['Pos_customerForm'], hooksObject);
