...
tabularOpts.name = 'pos.lookupValue';
tabularOpts.collection = LookupValue;
tabularOpts.columns = [
    {title: '<i class="fa fa-bars"></i>', tmpl: Meteor.isClient && Template.Pos_lookupValueAction},
    {data: "name", title: "Name"},
    {data: "private", title: "Private"},
    {
        data: "options",
        title: "Options",
        tmpl: Meteor.isClient && Template.Pos_lookupValueOptions
    },
];
